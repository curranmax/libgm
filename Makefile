...
HEADERS = gm.h diode.h simple_fso.h gm_utils.h usb_handle_registry.h pmd.h usb-3100.h usb-1608G.h
SOURCES = extern.cpp gm.cpp diode.cpp simple_fso.cpp gm_utils.cpp usb_handle_registry.cpp pmd.cpp usb-3100.cpp usb-1608G.cpp
...
install: clean all
	...
	#Installs mod-gm
	make -C mod
	cp mod/mod-gm $(INSTALL_PATH)/bin/mod-gm
